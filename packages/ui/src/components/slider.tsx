...
function Slider({
  ...
  // Base UI accepts either a scalar (single thumb) or an array (range).
  // Normalise to an array so the rendered thumb count always matches the
  // number of values, instead of defaulting to two thumbs for scalars.
